...
### Fixed
- Corrected the `mcp-name` marker case to `io.github.Evil-Bane/eyebrowse` so it matches the
  official MCP registry namespace (the registry preserves GitHub username case).
...
[0.3.10]: https://github.com/Evil-Bane/eyebrowse/compare/v0.3.9...v0.3.10
