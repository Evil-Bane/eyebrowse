...
- **`browser_type`**(ref, text, submit, clear) — Type text into a field by ref (top-frame or iframe ref like `f1e20`). `submit=True` presses Enter after. Returns a snapshot.
